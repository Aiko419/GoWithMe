...
namespace GoWithMe.Areas.Admin.Controllers
{
    public class NewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,PlaceID,Name,Content,Image")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,PlaceID,Name,Content,Image")] News news)
        {
            if (ModelState.IsValid)
            {
